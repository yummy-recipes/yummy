let strapiAdminNodeModules = require('fs').realpathSync(
...
let strapiContentManagerNodeModules = require('fs').realpathSync(
  'node_modules/strapi-plugin-content-manager',
)
strapiContentManagerNodeModules = require('path').resolve(
  strapiContentManagerNodeModules,
  '..',
)

let strapiUploadNodeModules = require('fs').realpathSync(
...
module.exports = {
  webpack: (config, webpack) => {
    ...
    config.resolveLoader = {
      modules: [strapiAdminNodeModules, 'node_modules'],
    }
